    ...
    <div class="row">
        ...
        <div class="col-md-6" style="width: 60%;">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form id="updateEvent" role="form" method="post">
                    {{csrf_field()}}
                    <input type="hidden" id="in-event_id" name="in-event_id" value="{{$event->id}}" />
                    <div class="box-body">
                        <div class="form-group">
                            <label for="eventName">{{trans('event.name')}}</label>
                            <input name="event_name" type="text" class="form-control" id="event_name" value="{{$event->event_name}}">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="box-body">
                                ...
                                <img onclick="BrowseServer('id_of_the_target_input');" src="{{$event->event_thumbnail}}" id="image_replace"
                            ...
                            <input id="id_of_the_target_input" type="hidden" name="thumbnail" value="{{$event->event_thumbnail}}"/>
                        </div><!-- /.box -->
                        <div class="form-group">
                            <label><i class="fa fa-paragraph"></i>Cách thức tham gia</label>
                            <textarea class="form-control" name="content" id="editor">{{$event->rule}}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="start_date">{{trans('event.start_date')}}</label>
                            <input name="event_started" type="text" class="form-control" id="start_date" value="{{$event->event_started}}">
                        </div>
                        <div class="form-group">
                            <label for="end_date">{{trans('event.end_date')}}</label>
                            <input name="event_ended" type="text" class="form-control" id="end_date" value="{{$event->event_ended}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                <option @if(isset($event->status) && (int)$event->status == 0){{"selected"}}@endif value="0">Verify</option>
                                <option @if(isset($event->status) && (int)$event->status == 1){{"selected"}}@endif value="1">Active</option>
                            </select>
                        </div>
                    </div>
                    <!-- /.box-body -->
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary">{{ trans('event.update_cat') }}</button>
                    </div>
                </form>
            </div>
            <!-- /.box -->
